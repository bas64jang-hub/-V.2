      ...
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs font-semibold text-slate-500 mb-1">
            <span>หน้าหลัก</span>
            <span>/</span>
            <span className="text-[#006948] truncate">โปรแกรมคำนวณขนาดฟิวส์ป้องกันหม้อแปลง (กฟภ.)</span>
          </div>
          <h1 className="text-base sm:text-2xl font-bold text-slate-900 tracking-tight flex flex-wrap items-center gap-2">
            ...
            <span className="text-[10px] sm:text-xs font-mono font-bold px-2.5 py-0.5 rounded-full bg-emerald-50 text-[#006948] border border-emerald-200 shrink-0">
              PEA &amp; IEEE C37.42
            </span>
          </h1>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="px-3 py-1.5 sm:py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold flex items-center gap-1.5 transition-colors border border-slate-200 shadow-xs cursor-pointer min-h-[36px]"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200 shadow-xs flex flex-col gap-4 relative overflow-hidden">
            ...
            {/* Action Buttons */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2 pt-4 border-t border-slate-100">
              <button
                type="button"
                onClick={handleSaveToTransformer}
                className="py-2.5 px-3 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-[#006948] text-xs font-bold border border-emerald-200 transition-colors flex items-center justify-center gap-1.5 shadow-xs cursor-pointer min-h-[38px]"
              >
                <Save className="w-4 h-4 shrink-0" />
                <span className="truncate">บันทึกลงข้อมูลหม้อแปลง</span>
              </button>
              <button
                type="button"
                onClick={() => window.print()}
                className="py-2.5 px-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition-colors flex items-center justify-center gap-1.5 border border-slate-200 shadow-xs cursor-pointer min-h-[38px]"
              >
                <Printer className="w-4 h-4 shrink-0" />
                <span className="truncate">พิมพ์รายงานสเปก (PDF)</span>
              </button>
            </div>
          </div>
